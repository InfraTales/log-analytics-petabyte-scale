# InfraTales | Petabyte Log Analytics – OpenSearch + S3 Data Lake on AWS

**Production-ready reference architecture for petabyte-scale log analytics with long-term retention.**

> **Petabyte-scale log analytics with OpenSearch cluster, S3 data lake, long-term retention, log parsing, and advanced search capabilities**
